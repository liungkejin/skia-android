...
Java_com_bhs_android_skia_SkCanvas_nNew(JNIEnv *env, jobject thiz,
...
extern "C"
JNIEXPORT jlong JNICALL
Java_com_bhs_android_skia_SkCanvas_nNew2(JNIEnv *env, jobject thiz,
                                         jobject bmp) {
...
Java_com_bhs_android_skia_SkCanvas_nFree(JNIEnv *env, jobject thiz, jlong native_ptr) {
...
Java_com_bhs_android_skia_SkCanvas_nReadPixels(JNIEnv *env, jobject thiz, jlong native_ptr,
                                               jobject bmp) {
    AndroidBitmapInfo info;
    if (AndroidBitmap_getInfo(env, bmp, &info) != 0) {
        return false;
...
extern "C"
JNIEXPORT void JNICALL
Java_com_bhs_android_skia_SkCanvas_nSave(JNIEnv *env, jobject thiz, jlong native_ptr) {
    SK_CANVAS->save();
}

extern "C"
JNIEXPORT void JNICALL
Java_com_bhs_android_skia_SkCanvas_nRestore(JNIEnv *env, jobject thiz, jlong native_ptr) {
    SK_CANVAS->restore();
}

extern "C"
JNIEXPORT jint JNICALL
Java_com_bhs_android_skia_SkCanvas_nSaveCount(JNIEnv *env, jobject thiz, jlong native_ptr) {
    return SK_CANVAS->getSaveCount();
}

extern "C"
JNIEXPORT void JNICALL
Java_com_bhs_android_skia_SkCanvas_nRestoreToCount(JNIEnv *env, jobject thiz, jlong native_ptr,
                                                   jint save_count) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_bhs_android_skia_SkCanvas_nTranslate(JNIEnv *env, jobject thiz, jlong native_ptr,
                                              jfloat dx, jfloat dy) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_bhs_android_skia_SkCanvas_nScale(JNIEnv *env, jobject thiz, jlong native_ptr, jfloat sx,
                                          jfloat sy) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_bhs_android_skia_SkCanvas_nRotate__JF(JNIEnv *env, jobject thiz, jlong native_ptr,
                                               jfloat degrees) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_bhs_android_skia_SkCanvas_nRotate__JFFF(JNIEnv *env, jobject thiz, jlong native_ptr,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_bhs_android_skia_SkCanvas_nSkew(JNIEnv *env, jobject thiz, jlong native_ptr, jfloat sx,
                                         jfloat sy) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_bhs_android_skia_SkCanvas_nConcat(JNIEnv *env, jobject thiz, jlong native_ptr,
                                           jfloatArray mat3x3) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_bhs_android_skia_SkCanvas_nSetMatrix(JNIEnv *env, jobject thiz, jlong native_ptr,
                                              jfloatArray mat3x3) {
    jfloat *mat = env->GetFloatArrayElements(mat3x3, nullptr);
    SkMatrix matrix;
...
extern "C"
JNIEXPORT void JNICALL
Java_com_bhs_android_skia_SkCanvas_nResetMatrix(JNIEnv *env, jobject thiz, jlong native_ptr) {
    SK_CANVAS->resetMatrix();
}

extern "C"
JNIEXPORT void JNICALL
Java_com_bhs_android_skia_SkCanvas_nClear(JNIEnv *env, jobject thiz, jlong native_ptr,
                                          jint color) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_bhs_android_skia_SkCanvas_nDrawColor(JNIEnv *env, jobject thiz, jlong native_ptr,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_bhs_android_skia_SkCanvas_nDiscard(JNIEnv *env, jobject thiz, jlong native_ptr) {
    SK_CANVAS->discard();
}

extern "C"
JNIEXPORT void JNICALL
Java_com_bhs_android_skia_SkCanvas_nDrawPaint(JNIEnv *env, jobject thiz, jlong native_ptr,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_bhs_android_skia_SkCanvas_nDrawPoints(JNIEnv *env, jobject thiz,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_bhs_android_skia_SkCanvas_nDrawPoint(JNIEnv *env, jobject thiz, jlong native_ptr,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_bhs_android_skia_SkCanvas_nDrawLine(JNIEnv *env, jobject thiz, jlong native_ptr,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_bhs_android_skia_SkCanvas_nDrawRect(JNIEnv *env, jobject thiz, jlong native_ptr,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_bhs_android_skia_SkCanvas_nDrawIRect(JNIEnv *env, jobject thiz, jlong native_ptr,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_bhs_android_skia_SkCanvas_nDrawOval(JNIEnv *env, jobject thiz, jlong native_ptr,
                                             jfloat left, jfloat top, jfloat right,
                                             jfloat bottom, jlong paint_native_ptr) {
    SkRect rect;
    rect.setLTRB(left, top, right, bottom);
...
extern "C"
JNIEXPORT void JNICALL
Java_com_bhs_android_skia_SkCanvas_nDrawCircle(JNIEnv *env, jobject thiz, jlong native_ptr,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_bhs_android_skia_SkCanvas_nDrawArc(JNIEnv *env, jobject thiz, jlong native_ptr,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_bhs_android_skia_SkCanvas_nDrawRoundRect(JNIEnv *env, jobject thiz, jlong native_ptr,
                                                  jfloat left, jfloat top, jfloat right,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_bhs_android_skia_SkCanvas_nDrawImage(JNIEnv *env, jobject thiz, jlong native_ptr,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_bhs_android_skia_SkCanvas_nDrawImageRect(JNIEnv *env, jobject thiz, jlong native_ptr,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_bhs_android_skia_SkCanvas_nDrawText(JNIEnv *env, jobject thiz, jlong native_ptr,
    ...
    sk_sp<SkTextBlob> textBlob = SkTextBlob::MakeFromString(str, *font, SkTextEncoding::kUTF8);
    SK_CANVAS->drawTextBlob(textBlob, x, y, *paint);
    //SK_CANVAS->drawString(str, x, y, *font, *paint);
}

extern "C"
JNIEXPORT void JNICALL
Java_com_bhs_android_skia_SkCanvas_nClipRect(JNIEnv *env, jobject thiz, jlong native_ptr,
                                             jfloat left, jfloat top, jfloat right,
                                             jfloat bottom, jint op, jboolean anti_alias) {
    SkRect rect;
    rect.setLTRB(left, top, right, bottom);
    SK_CANVAS->clipRect(rect, (SkClipOp) op, anti_alias);
}

extern "C"
JNIEXPORT void JNICALL
Java_com_bhs_android_skia_SkCanvas_nClipPath(JNIEnv *env, jobject thiz, jlong native_ptr,
                                             jlong path_native_ptr, jint op,
                                             jboolean anti_alias) {
    SkPath *path = (SkPath *) path_native_ptr;
    SK_CANVAS->clipPath(*path, (SkClipOp) op, anti_alias);
}